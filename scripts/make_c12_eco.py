...
c12_eco_ch1 = {
    ...
    "keyConcepts": [
        {"term": "Gross Domestic Product (GDP)", "explanation": "The total monetary market value of all final goods and services produced within the domestic territory of a country during a financial year."},
        {"term": "National Income (NNP_fc)", "explanation": "Net National Product at factor cost; the total factor income earned by normal residents of a nation within or outside domestic boundaries."},
        {"term": "Net Factor Income from Abroad (NFIA)", "explanation": "The difference between factor income earned by domestic residents abroad and factor income earned by non-residents within the domestic territory."},
        {"term": "Operating Surplus", "explanation": "The sum of factor incomes earned from ownership of property and enterprise: rent, royalty, interest, and corporate profits."},
        {"term": "Intermediate Consumption", "explanation": "Expenditure incurred by an enterprise on purchasing non-factor raw materials, fuel, and intermediate inputs used up in the production process."},
        {"term": "GDP Deflator", "explanation": "The price index calculated as (Nominal GDP / Real GDP) * 100, measuring the average price changes across all goods and services produced domestically."},
    ],
    "importantDates": [
        {"date": "1934", "event": "Simon Kuznets develops modern GDP metrics", "significance": "Presented the first comprehensive national income accounts to the US Congress."},
        {"date": "1949", "event": "National Income Committee appointed in India", "significance": "Chaired by Prof. P.C. Mahalanobis with D.R. Gadgil and V.K.R.V. Rao, laying the foundation of Central Statistics Office (CSO)."},
        {"date": "1954", "event": "Establishment of the Central Statistics Office (CSO)", "significance": "Official Indian agency tasked with compiling and releasing annual National Accounts Statistics."},
        {"date": "2015", "event": "Revision of Base Year and GDP Methodology in India", "significance": "Central Statistical Office shifted base year from 2004-05 to 2011-12 and adopted headline GDP at market prices."},
    ],
    "importantPeople": [
        {"name": "Simon Kuznets", "role": "American Nobel Laureate Economist", "contribution": "Pioneered the empirical framework of national income accounting and Gross National Product (GNP)."},
        {"name": "Prof. P.C. Mahalanobis", "role": "Father of Indian Statistics", "contribution": "Headed India's National Income Committee and established the National Sample Survey Organisation (NSSO)."},
        {"name": "Dr. V.K.R.V. Rao", "role": "Indian Pioneer of National Income Accounting", "contribution": "Conducted the first systematic academic estimates of India's national income in the 1930s combining census and survey data."},
        {"name": "John Maynard Keynes", "role": "British Macroeconomist", "contribution": "Established the theoretical framework for aggregate national demand, expenditure, and macroeconomic modeling."},
    ],
    "definitions": [
        {"term": "Depreciation (Consumption of Fixed Capital)", "definition": "The loss of monetary value of fixed capital assets over time due to regular wear and tear, passage of time, and foreseeable obsolescence.", "context": "Gross versus Net conversion rule"},
        {"term": "Double Counting", "definition": "The erroneous practice of counting the value of a commodity more than once at multiple stages of production, leading to gross overestimation of national income.", "context": "Value-added measurement methodology"},
        {"term": "Net Indirect Taxes (NIT)", "definition": "The difference between indirect taxes levied by the government on goods/services and economic subsidies granted to producers (Indirect Taxes - Subsidies).", "context": "Market Price versus Factor Cost valuation"},
        {"term": "Externalities", "definition": "Benefits (positive) or harms (negative) caused by an economic activity to third parties without any corresponding payment or penalty being exchanged in the market.", "context": "GDP and welfare limitations"},
    ],
    "importantFigures": [
        {"title": "National Income Aggregate Conversion Equations", "description": "Equations: Gross = Net + Depreciation; National = Domestic + NFIA; Market Price = Factor Cost + Net Indirect Taxes (NIT).", "type": "table"},
        {"title": "The Three Methods of Estimating GDP", "description": "Formula mapping: Value Added (GVA = Output - Intermediate), Income (CE + OS + MI), Expenditure (C + I + G + Net Exports).", "type": "flowchart"},
    ],
    "oneShotRevision": {
...
c12_eco_ch2 = {
    ...
    "keyConcepts": [
        {"term": "Barter System", "explanation": "An economic exchange mechanism where goods and services are exchanged directly for other goods and services without money."},
        {"term": "Double Coincidence of Wants", "explanation": "The rare condition where two parties simultaneously possess goods that each other desires in exchange."},
        {"term": "Legal Reserve Ratio (LRR)", "explanation": "The legally mandated fraction of total deposits that commercial banks must hold in reserve (comprising CRR and SLR)."},
        {"term": "Money Multiplier", "explanation": "The degree to which the money supply expands from an initial cash deposit, calculated as 1 / LRR."},
        {"term": "Repo Rate", "explanation": "The benchmark interest rate at which the Central Bank lends short-term funds to commercial banks against government securities."},
        {"term": "Open Market Operations (OMO)", "explanation": "The buying and selling of government bonds by the central bank in the open market to regulate liquidity in the banking system."},
    ],
    "importantDates": [
        {"date": "1 April 1935", "event": "Establishment of the Reserve Bank of India", "significance": "RBI created under the RBI Act 1934 following recommendations of the Hilton Young Commission."},
        {"date": "1 January 1949", "event": "Nationalisation of the RBI", "significance": "RBI transitioned from a private shareholder institution into India's public central bank."},
        {"date": "July 1969", "event": "First Major Bank Nationalisation", "significance": "Prime Minister Indira Gandhi nationalised 14 major private commercial banks to promote priority sector lending."},
        {"date": "November 2016", "event": "Demonetisation in India", "significance": "Government demonetised Rs 500 and Rs 1000 banknotes to curb counterfeit currency, black money, and promote digitisation."},
    ],
    "importantPeople": [
        {"name": "John Maynard Keynes", "role": "Macroeconomist & Author", "contribution": "Formulated liquidity preference theory, transaction and speculative demand for money, and the liquidity trap."},
        {"name": "Sir Osborne Smith", "role": "First Governor of the RBI (1935-1937)", "contribution": "Inaugurated the central banking operations of the Reserve Bank of India in Calcutta."},
        {"name": "C.D. Deshmukh", "role": "First Indian Governor of the RBI (1943-1949)", "contribution": "Guided the RBI through independence, partition, and nationalisation in 1949."},
        {"name": "Milton Friedman", "role": "Nobel Laureate & Monetarist", "contribution": "Advanced the Quantity Theory of Money, arguing inflation is always and everywhere a monetary phenomenon."},
    ],
    "definitions": [
        {"term": "Fiat Money", "definition": "Currency notes and coins that derive their legal value solely by government decree rather than intrinsic precious metal backing.", "context": "Forms of legal tender money"},
        {"term": "High-Powered Money (Monetary Base)", "definition": "The total monetary liabilities of the central bank, consisting of currency held by the public and reserves held by commercial banks with the central bank.", "context": "Central bank balance sheet and money multiplier"},
        {"term": "Liquidity Trap", "definition": "A monetary state where nominal interest rates drop near zero, making money demand perfectly elastic and rendering monetary easing ineffective.", "context": "Keynesian monetary economics"},
        {"term": "Moral Suasion", "definition": "A qualitative monetary tool where the central bank uses moral appeal, informal advice, and discussions to guide commercial bank lending.", "context": "Central banking qualitative control"},
    ],
    "importantFigures": [
        {"title": "RBI Monetary Aggregates (M1, M2, M3, M4)", "description": "Formula table: M1 = Currency + Demand Deposits + Other deposits; M2 = M1 + Post Office Savings; M3 = M1 + Time Deposits; M4 = M3 + All Post Office Deposits.", "type": "table"},
        {"title": "Credit Creation Formula", "description": "Total Deposits = Initial Primary Deposit * (1 / LRR); where LRR = CRR + SLR.", "type": "flowchart"},
    ],
    "oneShotRevision": {
...
full_notes_12_eco = {
    "c12-eco-ch1": c12_eco_ch1,
    "c12-eco-ch2": c12_eco_ch2,
}

output_content = "import { ChapterEnrichment } from './fullNotesClass10';\n\nexport const FULL_NOTES_CLASS_12_ECO: Record<string, ChapterEnrichment> = " + json.dumps(full_notes_12_eco, indent=2) + ";\n"

with open("/app/applet/src/data/fullNotesClass12Eco.ts", "w") as f:
    f.write(output_content)

print("Class 12 Economics full notes generated successfully!")
